...
TARGET = NVST-HighSpeed-TiO-20220120-001
TEMPLATE = app
...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_core452.dll
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_core452.dll


INCLUDEPATH += $$PWD/opencvlib
DEPENDPATH += $$PWD/opencvlib

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_highgui452.dll
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_highgui452.dll

INCLUDEPATH += $$PWD/opencvlib
DEPENDPATH += $$PWD/opencvlib

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_imgcodecs452.dll
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_imgcodecs452.dll

INCLUDEPATH += $$PWD/opencvlib
DEPENDPATH += $$PWD/opencvlib

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_imgproc452.dll
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/opencvlib/ -llibopencv_imgproc452.dll
