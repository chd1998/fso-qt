...
AboutWindow::AboutWindow(QWidget *parent) : QDialog(parent), ui(new Ui::AboutWindow) {
    ...
    ui->appName->setText("<h1>Andor Neo for NVST-TiO</h1>");
    ui->version->setAlignment(Qt::AlignHCenter);
    ui->version->setText("<h2>Version 20220120-004</h2>");
    ...
    ui->description->append("A GUI application for Andor sCMOS, based on Qt6.2+MinGW64+OpenCV.");
    ...
    ui->description->append("Release Date : 2021.10.30");
    ui->description->append(" ");
