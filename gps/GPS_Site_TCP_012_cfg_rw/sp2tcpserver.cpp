...
void SP2TCPServer::sendData()
{
    ...
    gClientConnection->write(lat_str_ip.toLatin1()+","+lon_str_ip.toLatin1()+","+alt_str.toLatin1()+","+time_str.toLatin1()+","+date_str.toLatin1()+"\n");
    ...
    QString tmpMsg;
    tmpMsg=clientIP+" : "+lat_str+","+lon_str+","+alt_str+","+time_str+","+date_str;
