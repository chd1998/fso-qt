...
bool MainWindow::writeCfg()
{
    ...
    QFile cfgfile(QDir::currentPath()+"//gps-"+siteID+".json");
...
bool MainWindow::openCfg()
{
    //打开Json文件并用QByteArray读取全部内容
        QFile file(QDir::currentPath()+"//gps-"+siteID+".json");
