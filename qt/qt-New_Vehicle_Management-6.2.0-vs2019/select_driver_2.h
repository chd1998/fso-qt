#ifndef SELECT_DRIVER_2_H
#define SELECT_DRIVER_2_H

#include <QDialog>
#include<QStandardItemModel>  //设置表格所用
namespace Ui {
class Select_Driver_2;
}

class Select_Driver_2 : public QDialog
{
    Q_OBJECT

public:
    explicit Select_Driver_2(QWidget *parent = nullptr);
    ~Select_Driver_2();
    static int line;
